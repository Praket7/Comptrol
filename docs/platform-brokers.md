...
Detection is not actuation. A detected display or bus does not make semantic mutation available. The action capability stays unavailable until its adapter and verification suite pass.
