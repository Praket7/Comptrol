...
```text
python3 scripts/generate_homebrew_formula.py --version VERSION --url ARCHIVE_URL --sha256 SHA256 --formula-name Comptrolling --arm64-only --output Formula/comptrolling.rb
```
